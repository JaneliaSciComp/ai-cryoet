...
from cryoet_catalog.api.routes.tomograms import launch_viewer_in_registry
...
def _render_zarr_median_png(zarr_path: str) -> bytes:
    ...
    from cryoet_catalog.imaging._mrc import _array_to_png_bytes
...
def _render_frames_median_png(frames_dir: str) -> bytes:
    ...
    from cryoet_catalog.imaging._mrc import _array_to_png_bytes
    from cryoet_catalog.imaging._tilt_image import (
...
def _cached_polar_png(
    ...
    """
    from cryoet_catalog.imaging._polar import render_polar_png
...
async def tilt_series_polar(
    ...
    """
    from cryoet_catalog.imaging._polar import POLAR_RENDER_VERSION
