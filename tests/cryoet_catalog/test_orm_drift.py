...
If you add a field to ``cryoet_schema/schema.py``, you must also add a column to
``cryoet_catalog/orm.py`` — or this test fails. Same in reverse, except for the
...
from cryoet_catalog import orm  # noqa: E402
